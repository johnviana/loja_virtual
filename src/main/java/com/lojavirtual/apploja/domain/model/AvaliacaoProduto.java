...
@Entity
@SequenceGenerator(name = "seq_ava_produto", sequenceName = "seq_ava_produto", initialValue = 1, allocationSize = 1)
public class AvaliacaoProduto {


    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_ava_produto")
    private Long id;
    ...
    @ForeignKey(value = ConstraintMode.CONSTRAINT, name = "preoduto_id"))
